...
private:
    ...
    void MinOptimizer(bool flag, int id);
    void MaxOptimizer(bool flag, int id);
    ...
    void mapTpdo(uint16_t parameterOffset, uint16_t mappingOffset, uint CANID, uint T_COBID); 
...
public slots:
    ...
    void OverDevProtect(std::vector<int> delta);
    void GetStopFlag(bool flag1, bool flag2);
    void GetFlag1(bool flag);
    void GetFlag2(bool flag);
/// SIGNALS:
signals:
